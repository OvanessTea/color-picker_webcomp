{
    ...
    *:focus {
    ...
    section#usualColors div:not(:last-child) {
      margin-right: 15px;
      margin-bottom: 10px;
    }
    attr, input {
  ...
  `;
    ...
    const html = `
      <div class="colorPicker__container">
        ...
        <rect class="pickerGradient" width="215" height="220" fill="url(#pickerHue)" rx="2" ry="2"/>
        <rect class="pickerGradient" width="215" height="220" fill="url(#pickerBrightness)" rx="2" ry="2"/>
        <circle id="pickerHandler" r="12.5" fill="none" stroke="#5B5B5B" stroke-width="1"/>
      ...
      <section id="hex">
        <p>Color</p>
        <label>
          <attr class="hex_attr">HEX</attr>
          <input class="hex_attr"value="FFFFFF">
      ...
      <section id="usualColors">
        <div class="exampleColor" style="background: #D0021B"></div>
        <div class="exampleColor" style="background: #F5A623"></div>
        <div class="exampleColor" style="background: #F8E71C"></div>
        <div class="exampleColor" style="background: #8B572A"></div>
        <div class="exampleColor" style="background: #7ED321"></div>
        <div class="exampleColor" style="background: #BD10E0"></div>
      </section>
    ...
    customElements.define("color-picker", class extends HTMLElement {
      constructor() {
        ...
        this.pickers = {
          ...
          color: {
            ...
            currentColor: root.getElementById("currentColor")
          }
        };
      ...
      updateUI({ hsb, rgb, hex } = this.state) {
        ...
        this.pickers.color.handler.setAttribute("fill", `#${hex}`);
        this.pickers.color.currentColor.setAttribute("style", `background: #${hex}`);
